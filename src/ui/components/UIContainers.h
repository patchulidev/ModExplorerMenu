...
namespace Modex
{
    namespace UIContainers
    {
		...
		void DrawObjectActionPanel(const ImVec2 &a_pos, const ImVec2 &a_size, std::unique_ptr<UITable> &a_view);
		void DrawSpellActionPanel(const ImVec2 &a_pos, const ImVec2 &a_size, std::unique_ptr<UITable> &a_view);
